package image // import "github.com/docker/infrakit/pkg/run/v0/image"
...
const (
	...
	EnvNamespaceTags = "INFRAKIT_IMAGE_NAMESPACE_TAGS"
)

var (
	log = logutil.New("module", "run/v0/image")
)
...
func Run(scope scope.Scope, name plugin.Name,
	...
	var imagePlugin instance.Plugin
	imagePlugin, err = image.NewPlugin(options.Namespace)
	if err != nil {
		return
	}
