...
// between executions.  It returns before the max attempts if the function returns true or has an error.
func WaitUntil(maxAttempts int, waitInterval time.Duration, f func() (bool, error)) error {
